...
import dataset, dataset_augmented
import Sandwitch
...
parser.add_argument("--save_dir", type=str, default="Out5", help="folder to save the test results")
parser.add_argument("--lr", type=float, default=1e-5, help="Learning rate")
parser.add_argument("--step", type=int, default=50, help="Learning rate decay every n epochs")
parser.add_argument("--reduce", type=float, default=0.5, help="Learning rate decay")
parser.add_argument("--max_epoch", type=int, default=201, help="Maximum epoch for training")
parser.add_argument("--num_cp", type=int, default=40, help="Save point")
